...
#         FORMULA_FILE_drives = '../examples/attend_grade_school/formula'
#         Domain_FILE_drives = '../examples/attend_grade_school/domain'
#         network = parse_to_network(FORMULA_FILE_drives, Domain_FILE_drives)
#         nodes = network.get_nodes()
#         self.assertEqual(('(x)', '_x'), nodes[0].get_lower_para_from_node())
#         self.assertEqual(('(x)', '_x'), nodes[1].get_lower_para_from_node())
#         self.assertEqual(('', ''), nodes[2].get_lower_para_from_node())
#
